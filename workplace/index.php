...
if(isset($_POST['submit'])){
     ...
     if( empty($name) || empty($salary ) || empty($email) || empty($cell) || empty($dpt)){
        ...
        connect()->query("INSERT INTO teachers (name, salary ,email ,cell,department ,gender,photo) VALUES
         ('$name','$salary','$email','$cell','$dpt','$gender' , '$file_name ')");
    ...
    <a class="btn btn-primary" href="./user.php" >All teachers</a>
        <div class="card shadow ">
            ...
            <div class="card-header">
                <h2 calss ="card-title">Create teachers account</h2>
            </div>
            <div class="card-body">
            <?php  echo $msg ?? ''  ?>
